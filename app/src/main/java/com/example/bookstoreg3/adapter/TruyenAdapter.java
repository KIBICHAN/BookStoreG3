...
public class TruyenAdapter extends Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            Truyen sanPham = array.get(position);
            myViewHolder.tensach.setText(sanPham.getTentruyen().trim());
            DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
            myViewHolder.giasach.setText("Giá: " + decimalFormat.format(Double.parseDouble(sanPham.getGiatruyen())) + "Đ");
